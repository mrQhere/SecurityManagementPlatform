...
| `gitleaks` | gitleaks/gitleaks | v9.0.1 |
...
Thanks to the **V9.0.1 Zero-Friction Plugin Registry**, adding your own custom security tools to the SMP pipeline is fully automated. You no longer need to wire up databases, UI toggles, or orchestration logic.
...
| **PCI-DSS v9.0.1** | Req 4, 6, 7, 8, 11, 12 | Payment card industry compliance |
