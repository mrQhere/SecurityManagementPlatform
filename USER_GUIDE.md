...
| `gitleaks` | gitleaks/gitleaks | v7.0.6 |
...
Thanks to the **V7.0.6 Zero-Friction Plugin Registry**, adding your own custom security tools to the SMP pipeline is fully automated. You no longer need to wire up databases, UI toggles, or orchestration logic.
...
| **PCI-DSS v7.0.6** | Req 4, 6, 7, 8, 11, 12 | Payment card industry compliance |
