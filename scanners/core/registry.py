...
def discover_scanners():
    ...
    V9.4.1: Also checks for PLUGIN_META for zero-config plug-and-play scanners.
    """
    import scanners
    package = scanners
...
def auto_discover_plugins() -> list:
    """
    V9.4.1 — Explicitly trigger plugin auto-discovery and return list of newly found plugins.
