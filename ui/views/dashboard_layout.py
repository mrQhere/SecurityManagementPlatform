...
class DashboardLayoutMixin:
    ...
    def _build_sidebar(self):
        ...
        # Version label
        ver = QLabel(f"{getattr(self, 'version', 'V5.4')} • SMP Console")
    ...
    def _build_settings_page(self):
        ...
        api_card = self._make_card(f"API Keys & Proxies — {getattr(self, 'version', 'V5.4')}")
        ...
        # ── Scan Profile ──
        profile_card = self._make_card(f"Scan Profile — {getattr(self, 'version', 'V5.4')}")
        ...
        auth_card = self._make_card(f"Authenticated Scan Headers — {getattr(self, 'version', 'V5.4')}")
