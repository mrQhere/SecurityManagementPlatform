...
declare -A TOOLS_AMD64=(
    ...
    [gitleaks]="https://github.com/gitleaks/gitleaks/releases/download/v9.1.3/gitleaks_8.21.2_linux_x64.tar.gz"
...
declare -A TOOLS_ARM64=(
    ...
    [gitleaks]="https://github.com/gitleaks/gitleaks/releases/download/v9.1.3/gitleaks_8.21.2_linux_arm64.tar.gz"
