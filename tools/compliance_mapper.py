...
Maps SMP finding types and CWE IDs to compliance control references:
  ...
  - PCI-DSS v7.0.2 (Requirements 6, 11)
...
# ── PCI-DSS v7.0.2 ─────────────────────────────────────────────────────────────
# Source: PCI Security Standards Council PCI DSS v7.0.2 (March 2022)
_PCI_DSS_V4 = {
...
def format_compliance_table(summary: dict) -> str:
    ...
    lines = [
        ...
        f"PCI-DSS v7.0.2        {summary['pci_dss_coverage']:>3}%     "
