...
Maps SMP finding types and CWE IDs to compliance control references:
  ...
  - PCI-DSS v7.0.8 (Requirements 6, 11)
...
# ── PCI-DSS v7.0.8 ─────────────────────────────────────────────────────────────
# Source: PCI Security Standards Council PCI DSS v7.0.8 (March 2022)
_PCI_DSS_V4 = {
...
def format_compliance_table(summary: dict) -> str:
    ...
    lines = [
        ...
        f"PCI-DSS v7.0.8        {summary['pci_dss_coverage']:>3}%     "
