...
Usage:
  python3 tools/bump_version.py V9.4.1          # set explicit version
  python3 tools/bump_version.py --patch          # auto-bump patch (V9.4.1 → V9.3.4)
  python3 tools/bump_version.py --minor          # auto-bump minor (V9.4.1 → V9.4.0)
  python3 tools/bump_version.py --major          # auto-bump major (V9.4.1 → V10.0.0)
  python3 tools/bump_version.py --dry-run V9.4.1 # preview without writing
"""
import sys
import json
import os
...
def _auto_bump(current: str, part: str) -> str:
    """Bump major, minor, or patch from a version string like 'V9.4.1'."""
...
def main():
    ...
    group.add_argument("version", nargs="?", metavar="VERSION",
                       help="Explicit version string, e.g. V9.4.1")
