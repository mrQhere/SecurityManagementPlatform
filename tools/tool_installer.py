...
def _download_missing_tools_locally(missing):
    ...
    urls_amd64 = {
        ...
        "Trivy":        "https://github.com/aquasecurity/trivy/releases/download/v0.53.0/trivy_0.53.0_Linux-64bit.tar.gz",
    }
    urls_arm64 = {
        ...
        # New V5.2 Enterprise binaries
        "Amass":        "https://github.com/owasp-amass/amass/releases/download/v4.2.0/amass_linux_arm64.zip",
