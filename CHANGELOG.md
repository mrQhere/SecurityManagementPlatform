...
- Corrected CVSS label in PDF reports from "CVSS v9.4.2" to "CVSS v3.1" (SMP version was leaking into standard label).
- Corrected PCI-DSS label in PDF reports from "PCI-DSS v9.4.2" to "PCI-DSS v4.0".
- Fixed README license badge showing "Proprietary" — now correctly shows "MIT".
- Synchronized all V9.3.x stale version strings to V9.4.2 across tools, scanners, UI, and docs.
